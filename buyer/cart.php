        ...
        while ($fetch_carts = $select_cart->fetch(PDO::FETCH_ASSOC)) {
            ...
            if ($select_products->rowCount() > 0) {
                ...
                <form action="" method="POST" class="item">
                    ...
                    <div class="flex">
                        <input class="btn" type="number" name="qty" required min="1" value=<?= $fetch_carts['qty'] ?> max="99" maxlength="2" class="qty">
                        <button type="submit" name="update_cart" class="bx bxs-edit fa-edit btn"></button>
                    </div>
                    <button type="submit" name="delete_item" class="btn" onclick="return confirm('are u sure to delete this item');">delete</button>
                </form>
                <?php
