        ...
        <div class="main">
            ...
            <section>
                ...
                <div id="AllProduct">
                    ...
                    $pvalue = "pending";
                    $product = $conn2->prepare("SELECT * FROM `products` WHERE `status`= ? ");
...
// $pvaluetwo="active";
                    $product2 = $conn2->prepare("SELECT * FROM `products` WHERE `status` = ?");
...
// $pvaluetwo="active";
                    $product3 = $conn2->prepare("SELECT * FROM `products` WHERE `status` = ?");
                    $product3->execute(["deactive"]);
                    $result3 = $product3->rowCount();
                    // ==================PRODUCT DEACTIVE ROWCOUNT PHP CODE ============================================================
                    ...
                    <div class="admins-box">
                        ...
                        <a class="viewpath btn" href="admin_pendingproduct.php">View</a>
                    ...
                    <div class="admins-box">
                        ...
                        <a class="viewpath btn" href="admin_activeproduct.php">View</a>
